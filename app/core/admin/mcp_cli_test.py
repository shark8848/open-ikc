...
CLI_WHITELIST: dict[str, CommandSpec] = {
    ...
    "wiki-tree": CommandSpec(positional=1, flags=frozenset({"--page", "--page-size"})),
    "wiki-page": CommandSpec(positional=1, flags=frozenset({"--page-id"})),
    "wiki-search": CommandSpec(positional=1, flags=frozenset({"--q", "--tag"})),
    "graph-stat": CommandSpec(positional=1),
    "graph-nodes": CommandSpec(positional=1, flags=frozenset({"--entity-type", "--page", "--page-size"})),
    "graph-edges": CommandSpec(positional=1, flags=frozenset({"--relation-type", "--page", "--page-size"})),
    "graph-neighbors": CommandSpec(positional=1, flags=frozenset({"--entity-id", "--depth"})),
    "graph-export": CommandSpec(positional=1, flags=frozenset({"--to-path"})),
...
MCP_TOOL_WHITELIST: dict[str, frozenset[str]] = {
    ...
    "wiki_tree": frozenset({"kbId", "page", "pageSize"}),
    "wiki_page": frozenset({"kbId", "pageId"}),
    "wiki_search": frozenset({"kbId", "q", "tag"}),
    "graph_stat": frozenset({"kbId"}),
    "graph_nodes": frozenset({"kbId", "entityType", "page", "pageSize"}),
    "graph_edges": frozenset({"kbId", "relationType", "page", "pageSize"}),
    "graph_neighbors": frozenset({"kbId", "entityId", "depth"}),
    "graph_export": frozenset({"kbId"}),
