...
/** 线性 SVG 图标基础封装：24x24 视口、圆角线帽，风格对齐主流 AI 产品原生图标。 */
function createIcon(children: ReactNode) {
  return function Icon({ size = 18, strokeWidth = 1.8, className }: IconProps) {
    return (
      <svg
        width={size}
        height={size}
...
export const PulseIcon = createIcon(<path d="M22 12h-4l-3 9L9 3l-3 9H2" />)
